        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="flex items-center gap-10 mb-8 mt-4">
              ...
              >
                <img
                  src="https://beaver-workshop.s3.amazonaws.com/Images/viber.png"
              ...
              >
                <img
                  src="https://beaver-workshop.s3.amazonaws.com/Images/telegram.png"
                  className="h-12 w-12 md:h-14 md:w-14"
                  alt="Telegram"
                />
              </a>
            ...
            <div className="relative w-full max-w-[520px] h-[260px] md:h-[360px]">
              ...
              <img
                src="https://beaver-workshop.s3.amazonaws.com/Images/bob2.png"
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden w-full h-[260px] md:h-[360px]">
              ...
              <img
                src="https://beaver-workshop.s3.amazonaws.com/Images/Ukraine2.png"
                className="relative z-10 w-full h-full object-contain"
                alt="Карта України"
              />
            </div>
